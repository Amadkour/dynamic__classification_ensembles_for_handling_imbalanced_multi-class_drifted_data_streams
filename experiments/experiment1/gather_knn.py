...
methods = [
    ...
    "KNN-KNORAU1", "KNN-KNORAU1", "KNN-KNORAUE1","KNN-KNORAE2",
    # "SVM-KNORAU1",
    # "GNB-KNORAU2", "HT-KNORAU2", "KNN-KNORAU2", "SVM-KNORAU2",
    # "GNB-KNORAE1", "HT-KNORAE1", "KNN-KNORAE1", "SVM-KNORAE1",
    # "GNB-KNORAE1", "HT-KNORAE2", "KNN-KNORAE2", "SVM-KNORAE2",
]
random_states = [100]
# random_states = [804]
# distributions = [[0.97, 0.03], [0.95, 0.05], [0.85, 0.15]]
...
drifttype = [(5,True),(5,False), (None,True)]
n_drifts = 1
n_chunks = 199
                ...
                for m, flip_y in enumerate(label_noises):
                    ...
                    if spacing == None and drift_type == True:
                        ...
                        results = np.load(
                            ...
                            "experiments/experiment1/results-adwin/svm/ADWIN/%s" % str(stream).replace('d97','d96') + '.npy'
                        )

                        scores[i, j, k, l, m] = results
scores_metrics_22 = scores
np.save("scores_exp_1_matrix", scores_metrics_22)
scores = np.mean(scores_metrics_22, axis=1)
print(scores.shape)
np.save("scores_exp_1_svm", scores)
