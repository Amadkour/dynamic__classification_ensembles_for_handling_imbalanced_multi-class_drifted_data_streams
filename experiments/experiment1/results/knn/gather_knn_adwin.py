...
methods = [
    ...
    "KNN-KNORAU1", "KNN-KNORAU1", "KNN-KNORAU1","KNN-KNORAU1",
   ]
random_states = [100]
# random_states = [804]
                ...
                for m, flip_y in enumerate(label_noises):
                    ...
                    if spacing == None and drift_type == True:
                        ...
                        results = np.load(
                            ...
                            "experiments/experiment1/results-adwin/knn/ADWIN/%s" % str(stream).replace('d97','d96') + '.npy'
                        )
...
print(scores.shape)
np.save("scores_exp_1_knn_adwin", scores)
